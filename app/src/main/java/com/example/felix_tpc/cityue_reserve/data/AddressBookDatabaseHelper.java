...
package com.example.felix_tpc.cityue_reserve.data;
...
class AddressBookDatabaseHelper extends SQLiteOpenHelper {
   private static final String DATABASE_NAME = "E_reserve.db";
   ...
   public void onCreate(SQLiteDatabase db) {
      ...
      final String CREATE_CONTACTS_TABLE =
         ...
         Contact.COLUMN_Time + " TEXT, " +
         Contact.COLUMN_Doctor + " TEXT, " +
         Contact.COLUMN_Symptom + " TEXT);";
